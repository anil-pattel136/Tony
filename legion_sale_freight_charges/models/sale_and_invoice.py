...
class SaleOrderInherit(models.Model):
    ...
    freight_charges = fields.Monetary(string='Freight Charges', readonly=False, cpmpute='_amount_all')

    # """Method for amount total after addition freight charges"""
    ...
    def _amount_all(self):
        ...
        for order in self:
            ...
            order.update({
                ...
                'amount_total': amount_untaxed + amount_tax + self.freight_charges,
            })

    # """Method for posting freight charges if invoice directly without payment"""
